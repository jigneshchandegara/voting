...
import { base_url, delete_election_list_findid, delete_party_list_findid, delete_voter_list_findid, get_election_list, get_party_list, get_voter_list, post_connection_create, post_election_create, post_party_create, post_voter_create } from "../AllURL";
...
let post_election = (action) => {
    ...
    return axios.post(base_url + post_election_create, action.payload).then((res) => {
...
let delete_election = (action) => {
    ...
    return axios.delete(base_url + delete_election_list_findid + action.payload).then((res) => {
...
let post_voter = (action) => {
    ...
    return axios.post(base_url + post_voter_create, action.payload).then((res) => {
...
let delete_voter = (action) => {
    console.log(action, "this action from get voter");
    return axios.delete(base_url + delete_voter_list_findid + action.payload).then((res) => {
...
export { post_party, get_party, delete_party, post_election, get_election, delete_election, post_voter, get_voter, delete_voter , post_connection }